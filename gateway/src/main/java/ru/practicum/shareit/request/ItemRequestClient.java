...
public class ItemRequestClient extends BaseClient {
    ...
    @Autowired
    public ItemRequestClient(@Value("${backend.url}") String serverUrl, RestTemplateBuilder builder) {
        super(
                builder
    ...
    public ResponseEntity<Object> getItemRequestByRequestIdAndUserId(Long userId, Long requestId) {
